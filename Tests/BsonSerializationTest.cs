    ...
    public class BsonSerializationTest
    {
        ...
        public void CanSerializeUser()
        {
            var userEntity = new UserEntity
                (Guid.NewGuid(), "someUserName", "", "", 0, Guid.NewGuid());
        ...
        public void CanSerializeGame()
        {
            ...
            {
                new Player(Guid.NewGuid(), "name1") 
                { Decision = PlayerDecision.Paper, Score = 42 },
                new Player(Guid.NewGuid(), "name2") 
                { Decision = PlayerDecision.Rock, Score = 40 }
            };
        ...
        public void CanSerializeNotStartedGame()
        {
            var entity = new GameEntity
                (Guid.NewGuid(), GameStatus.WaitingToStart, 10, 0, new List<Player>());
            AssertCorrectSerialization(entity);
        }
        ...
        public void CanSerializeNotStartedGameWithPlayers()
        {
            ...
            var entity = new GameEntity
                (Guid.NewGuid(), GameStatus.WaitingToStart, 10, 2, players);
            AssertCorrectSerialization(entity);
        }
